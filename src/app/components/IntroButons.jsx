...
function IntroButons() {
  const sites = [
    { name: 'Site 1', url: 'https://1a-serie.beieducacaopedagogico.com/' },
    { name: 'Site 2', url: 'https://1a-serie-2.beieducacaopedagogico.com/' },
    { name: 'Site 3', url: 'https://1a-serie-3.beieducacaopedagogico.com/' }
  ];
